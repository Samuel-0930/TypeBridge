...
- **상대방 MBTI 추측 퀴즈**: 상대의 유형을 모를 경우, 행동 패턴 관찰을 통해 MBTI를 추론해주는 퀴즈 기능 제공
- **나의 강점 시너지 분석**: 나의 MBTI와 상대방의 MBTI를 조합하여, 내가 가진 강점을 200% 활용할 수 있는 전략 제시

### 2️⃣ 결과 이미지 저장 및 공유
- **인스타그램 스토리 최적화**: 분석 결과를 모바일 화면에 딱 맞는 **9:16 비율**의 고해상도 이미지로 저장
- **프리미엄 디자인**: 저장 시 깔끔한 브랜딩과 배경 스타일이 적용된 전용 카드 레이아웃 제공

### 3️⃣ 프리미엄 AI 대화 내역 분석
- **호감도 수치화**: 카톡 메시지 등 대화 내역을 분석하여 상대방의 호감도를 **0%~100% 점수**로 산출
- **Secret Feedback**: 텍스트 뒤에 숨겨진 상대방의 심리를 AI가 읽어주는 정밀 피드백

### 4️⃣ 단계별 액션 플랜 (Action Plan)
